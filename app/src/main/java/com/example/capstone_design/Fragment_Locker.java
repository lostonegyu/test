...
public class Fragment_Locker extends Fragment {
    Button Locker_btn;
    private View view;

    public static Fragment_Locker newInstance() {
        Fragment_Locker fragment_locker = new Fragment_Locker();
        return fragment_locker;
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_locker, container, false);

        Locker_btn = view.findViewById(R.id.locker_btn);
